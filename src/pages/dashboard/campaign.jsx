      ...
      <div className="mt-12 mb-8 flex flex-col gap-12">
        <Card>
          <div><CardHeader variant="gradient" color="blue" className="mb-8 p-6">
            ...
            <Button type="Button"
              className=" companeAd text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
              ...
              <div className="container mx-auto p-4">
                <Card className="absolute top-2/4 left-2/4 w-full max-w-[40rem] -translate-y-2/4 -translate-x-2/4">
                  ...
                  <CardBody className="flex flex-col gap-4">
                    ...
                    <Input label="Spacial Ad Categories" size="lg" required='true'
                      value={campaign.special_ad_categories}
                      onChange={(e) => setCampaign({ ...campaign, special_ad_categories: e.target.value })} />
                    {/* <Select label="Spacial Ad Categories"
                      value={campaign.special_ad_categories}
                      onChange={(e) => setCampaign({ ...data, special_ad_categories: e.target.value })}
                    >
                      Declare if your ads are related to credit, employment or housing, or about social issues, elections or politics. Requirements differ by country.
                      {spacialAddArr?.map((option) => (
                        // console.log(option)
                    ...
                    onChange={(e) => setCampaign({ ...data, objective: e.target.value })}>
                    ...
                    onChange={(e) => setCampaign({ ...data, status: e.target.value })}
                    >
